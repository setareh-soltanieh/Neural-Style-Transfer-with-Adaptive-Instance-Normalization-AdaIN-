...
parser.add_argument("-content_dir", default="Datasets/COCO1k/", help="Directory containing content images")
parser.add_argument("-style_dir", default="Datasets/wikiart1k/", help="Directory containing style images")
...
parser.add_argument("-save_weights", default="model_1k", help="Path to save model weights")
...
plt.ylabel("Loss")
plt.legend()
plt.title("Losses Over Training For 1K")
plt.grid(True)

# Save the plot as an image file
plt.savefig("loss_plot_1k.png")
plt.close()